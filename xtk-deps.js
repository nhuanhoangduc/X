...
goog.addDependency('../../../../core/event.js', ['X.event', 'X.event.HoverEndEvent', 'X.event.HoverEvent', 'X.event.ModifiedEvent', 'X.event.PanEvent', 'X.event.RenderEvent', 'X.event.ResetViewEvent', 'X.event.RotateEvent', 'X.event.ScrollEvent', 'X.event.WindowLevelEvent', 'X.event.ZoomEvent', 'X.event.events'], ['X', 'X.object', 'X.vector', 'goog.events', 'goog.events.Event'], {});
...
goog.addDependency('../../../../io/loader.js', ['X.loader'], ['X.base', 'X.event', 'X.object', 'X.parserCRV', 'X.parserDCM', 'X.parserFSM', 'X.parserGZ', 'X.parserIMAGE', 'X.parserLBL', 'X.parserLUT', 'X.parserMGZ', 'X.parserNII', 'X.parserNRRD', 'X.parserOBJ', 'X.parserSTL', 'X.parserTRK', 'X.parserVTK', 'goog.structs.Map'], {});
...
goog.addDependency('../../../../io/parserGZ.js', ['X.parserGZ'], ['X.event', 'X.parser', 'X.triplets', 'Zlib.Gunzip'], {});
...
goog.addDependency('../../../../io/parserNII.js', ['X.parserNII'], ['X.event', 'X.object', 'X.parser', 'X.triplets', 'Zlib.Gunzip', 'goog.math.Vec3'], {});
goog.addDependency('../../../../io/parserNRRD.js', ['X.parserNRRD'], ['X.event', 'X.object', 'X.parser', 'X.triplets', 'Zlib.Gunzip', 'goog.math.Vec3'], {});
...
goog.addDependency('../../../../visualization/renderer3D.js', ['X.renderer3D'], ['X.buffer', 'X.caption', 'X.matrix', 'X.renderer', 'X.shaders', 'X.triplets', 'X.vector', 'goog.structs.Map'], {});
