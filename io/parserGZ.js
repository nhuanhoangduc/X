...
X.parserGZ = function() {
   ...
   * @const
   */
  this._classname = 'parserGZ';

};
// inherit from X.parser
goog.inherits(X.parserGZ, X.parser);


/**
 * @inheritDoc
 */
X.parserGZ.prototype.parse = function(container, object, data, flag) {

  X.TIMER(this._classname + '.parse');

  var inflate = new Zlib.Gunzip(new Uint8Array(data));
  this._data = inflate.decompress();
  window.nhuan = this._data;
 ...
 * @protected
 */
X.parserGZ.prototype.parseASCII = function(p, n, data) {
 ...
 */
X.parserGZ.prototype.parseBIN = function(p, n, triangleCount) {
...
goog.exportSymbol('X.parserGZ', X.parserGZ);
goog.exportSymbol('X.parserGZ.prototype.parse', X.parserGZ.prototype.parse);
