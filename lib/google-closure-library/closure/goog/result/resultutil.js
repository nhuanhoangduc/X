 ...
 * <pre>
 *
 * var result = xhr.getJson('testdata/xhr_test_window.JSON.data');
 *
 * // Transform contents of returned data using 'processJson' and create a
 * // transformed result to use returned window.JSON.
 ...
 * var result2 = xhr.getJson('testdata/xhr_test_window.JSON.data');
 *
