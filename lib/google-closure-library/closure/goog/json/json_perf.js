...
function testSerialize() {
  ...
  table.run(function() {
    var s = window.JSON.stringify(obj);
  }, 'Stringify using window.JSON.stringify');

  table.run(function() {
    var s = goog.window.JSON.serialize(obj);
  }, 'Stringify using goog.window.JSON.serialize');
}
...
function testParse() {
  ...
  table.run(function() { var o = window.JSON.parse(s); }, 'Parse using window.JSON.parse');

  table.run(function() {
    var o = goog.window.JSON.parse(s);
  }, 'Parse using goog.window.JSON.parse');
}
