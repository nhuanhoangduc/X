...
goog.provide('goog.window.JSON.NativeJsonProcessor');
 ...
 * for details on the differences from goog.window.JSON.
 *
 ...
 *     serialization.
 * @param {?goog.window.JSON.Reviver=} opt_reviver An optional reviver to use during
 *     parsing.
 * @constructor
 * @implements {goog.window.JSON.Processor}
 * @final
 */
goog.window.JSON.NativeJsonProcessor = function(opt_replacer, opt_reviver) {
  ...
  /**
   * @type {goog.window.JSON.Reviver|null|undefined}
   * @private
   */
...
/** @override */
goog.window.JSON.NativeJsonProcessor.prototype.stringify = function(object) {
  return goog.global['JSON'].stringify(object, this.replacer_);
};


/** @override */
goog.window.JSON.NativeJsonProcessor.prototype.parse = function(s) {
