...
function testGetTextWithJson() {
  ...
  return xhr.get('testdata/xhr_test_window.JSON.data').then(function(responseText) {
...
function testGetJson() {
  ...
  return xhr.getJson('testdata/xhr_test_window.JSON.data', {xssiPrefix: 'while(1);\n'})
...
function testSerialRequests() {
  ...
  return xhr.get('testdata/xhr_test_text.data')
      .then(function(response) {
        return xhr.getJson(
            'testdata/xhr_test_window.JSON.data', {xssiPrefix: 'while(1);\n'});
      })
      .then(function(responseObj) {
