...
goog.addDependency('json/window.JSON.js', ['goog.json', 'goog.window.JSON.Replacer', 'goog.window.JSON.Reviver', 'goog.window.JSON.Serializer'], []);
...
goog.addDependency('debug_loader_integration_tests/goog_bootstrap_tests_googmodule_test.js', ['goog.debug_loader_integration_test.goog_bootstrap_tests_googmodule_test'], ['goog.debug.loader.integrationTestCommon'], {'module': 'goog'});
goog.addDependency('debug_loader_integration_tests/goog_bootstrap_tests_googmoduledln_test.js', ['goog.debug_loader_integration_test.goog_bootstrap_tests_googmoduledln_test'], ['goog.debug.loader.integrationTestCommon'], {'module': 'goog'});
goog.addDependency('debug_loader_integration_tests/goog_bootstrap_tests_googmodulewithdeps_test.js', ['goog.debug_loader_integration_test.goog_bootstrap_tests_googmodulewithdeps_test'], ['goog.debug.loader.integrationTestCommon'], {'module': 'goog'});
goog.addDependency('debug_loader_integration_tests/goog_bootstrap_tests_provide_test.js', ['goog.debug_loader_integration_test.goog_bootstrap_tests_provide_test'], ['goog.debug.loader.integrationTestCommon'], {'module': 'goog'});
goog.addDependency('debug_loader_integration_tests/goog_bootstrap_tests_providewithdeps_test.js', ['goog.debug_loader_integration_test.goog_bootstrap_tests_providewithdeps_test'], ['goog.debug.loader.integrationTestCommon'], {'module': 'goog'});
