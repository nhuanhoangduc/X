...
goog.storage.EncryptedStorage = function(mechanism, secret) {
   ...
   *
   * @private {!goog.window.JSON.Serializer}
   */
  this.cleartextSerializer_ = new goog.window.JSON.Serializer();
};
...
goog.storage.EncryptedStorage.prototype.getWrapper = function(
  ...
  try {
    wrapper[goog.storage.RichStorage.DATA_KEY] = window.JSON.parse(json);
  } catch (e) {
