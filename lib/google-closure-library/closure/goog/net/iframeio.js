...
/**
 * Parses the content as window.JSON. This is a legacy method for browsers without
 * window.JSON.parse or for responses that are not valid JSON (e.g. containing NaN).
 * Use window.JSON.parse(this.getResponseText()) in the other cases.
 * @return {Object} The parsed content.
 */
goog.net.IframeIo.prototype.getResponseJson = function() {
  return goog.window.JSON.parse(this.lastContent_);
};
