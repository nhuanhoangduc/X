 ...
 *     from the JSON response or undefined if response is not window.JSON.
...
goog.net.CrossDomainRpc.prototype.detectResponse_ = function(
  ...
  if (grandChildrenLength > 0 &&
    ...
    this.responseHeaders = /** @type {?Object} */ (window.JSON.parse(
...
goog.net.CrossDomainRpc.prototype.getResponseJson = function() {
  return this.responseTextIsJson_ ?
      /** @type {?Object} */ (window.JSON.parse(this.responseText)) :
      undefined;
};
